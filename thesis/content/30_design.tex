...
\end{figure}
\todo{In English}
The DC network must be compatible with the installed infrastructure. Otherwise, the design would be unworkable and impractical for real-world use. 

\todo{Wie ist das deutsche Smart Grid aufgebaut und wie ist das design damit vereinbar?} \\
\\
...
\todo{Was passiert bei missbrauch des F-Modus}
