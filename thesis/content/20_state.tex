...
External market participants \gls{EMT} are all other authorized participants in the energy network that can establish a communication connection with the \gls{SMGW}. These include power grid providers and electricity suppliers. The \gls{SMGW} ignores all other communication requests that do not come from the \gls{GWA} or \gls{EMT}s in order to prevent attacks.\\
\end{enumerate}
